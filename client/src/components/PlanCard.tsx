...
const PlanCard = () => {
  return (
    <div className='h-[350px] w-full cursor-pointer mr-3 border rounded p-3'>
      <div className='rounded bg-gradient-to-r from-cyan-400 to-blue-500 w-full p-3 text-white font-bold'>
        <h3 className='text-2xl'>Basic</h3>
        <p className='font-light'>$5.00</p>
      </div>
      <div className='border-b py-4 flex font-regular items-center'>
